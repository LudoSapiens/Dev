...
#endif
void PrintJoint( XnUserID player, XnSkeletonJoint jointID, const char* jointName )
{
	XnSkeletonJointPosition jointPos;
	g_UserGenerator.GetSkeletonCap().GetSkeletonJointPosition( player, jointID, jointPos );
	printf("%s: %g, %g, %g\n", jointName, jointPos.position.X, jointPos.position.Y, jointPos.position.Z );
}
void PrintSkeleton( XnUserID player )
{
   return;
   ...
   printf("Player %d:\n", player);
   //PrintJoint( player, XN_SKEL_HEAD          , "          HEAD" );
   //PrintJoint( player, XN_SKEL_NECK          , "          NECK" );
   //PrintJoint( player, XN_SKEL_LEFT_SHOULDER , " LEFT_SHOULDER" );
   //PrintJoint( player, XN_SKEL_LEFT_ELBOW    , "    LEFT_ELBOW" );
   PrintJoint( player, XN_SKEL_LEFT_HAND     , "     LEFT_HAND" );
   //PrintJoint( player, XN_SKEL_RIGHT_SHOULDER, "RIGHT_SHOULDER" );
   //PrintJoint( player, XN_SKEL_RIGHT_ELBOW   , "   RIGHT_ELBOW" );
   PrintJoint( player, XN_SKEL_RIGHT_HAND    , "    RIGHT_HAND" );
   //PrintJoint( player, XN_SKEL_TORSO         , "         TORSO" );
   //PrintJoint( player, XN_SKEL_LEFT_HIP      , "      LEFT_HIP" );
   //PrintJoint( player, XN_SKEL_LEFT_KNEE     , "     LEFT_KNEE" );
   //PrintJoint( player, XN_SKEL_LEFT_FOOT     , "     LEFT_FOOT" );
   //PrintJoint( player, XN_SKEL_RIGHT_HIP     , "     RIGHT_HIP" );
   //PrintJoint( player, XN_SKEL_RIGHT_KNEE    , "    RIGHT_KNEE" );
   //PrintJoint( player, XN_SKEL_RIGHT_FOOT    , "    RIGHT_FOOT" );
}
