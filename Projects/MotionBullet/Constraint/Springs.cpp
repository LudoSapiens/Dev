...
=============================================================================*/
#include <MotionBullet/Constraint/Springs.h>
...
PosSpring::anchor( const Vec3f& /*posA*/, const Vec3f& /*posB*/, float restLength )
{
   ...
   //_anchorA = _bodyA->referential().globalToLocal() * posA;
   //_anchorB = _bodyB->referential().globalToLocal() * posB;
}
...
//! 
btTypedConstraint* 
AnchoredPosSpring::btConstraint()
{
   return 0;
}
