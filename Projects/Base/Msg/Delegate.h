...
// IMPORTANT NOTES
// ===============
// Almost all of the code below is taken from Don Clugston as is indicated.
// As stated on http://www.codeproject.com/cpp/FastDelegate.asp, the code
// is released under public domain, and can therefore be used without any
// limitations (refer to http://archive.org/ if the link ever disappears).
// The modifications are just kept to a minimal for maintenance reasons.
// The changes made include:
// - Renaming 'fastdelegate' namespace to our own (using NAMESPACE_BEGIN/END).
// - Renaming MakeDelegate() to makeDelegate() to fit our naming conventions.
// Every modification is surrounded by #if BASE_DELEGATE_CHANGES..#endif.

#define BASE_DELEGATE_CHANGES 1

#if BASE_DELEGATE_CHANGES

// Using this define to rename the fastdelegate namespace.
#define fastdelegate   Dev

// Using this define to rename FastDelegateN to a simpler DelegateN.
#define FastDelegate0  Delegate0
#define FastDelegate1  Delegate1
#define FastDelegate2  Delegate2
#define FastDelegate3  Delegate3
#define FastDelegate4  Delegate4
#define FastDelegate5  Delegate5
#define FastDelegate6  Delegate6
#define FastDelegate7  Delegate7
#define FastDelegate8  Delegate8

// Using this define to alter case of MakeDelegate.
#define MakeDelegate   makeDelegate

#endif //BASE_DELEGATE_CHANGES
...
// CHANGES MADE BY JOCELYN HOULE BELOW
// 28-Nov-07 1.5.1* Fixing GCC warning in DelegateMemento ctor due to wrong member initialization order.
