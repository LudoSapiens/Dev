...
=============================================================================*/
#ifndef GFX_D3D_MANAGER_H
#define GFX_D3D_MANAGER_H
...
private:
   ...
   IDirect3DSurface9*  _oldRenderTarget;
   IDirect3DSurface9*  _oldDepthStencilSurface;
};
